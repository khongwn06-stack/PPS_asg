...
struct Application {        // Parking pass application (created by application module)
    string appID;
    string studentID;
    int applyMonth;         
    int applyYear;
...
struct Transaction {        // Transaction record (created after payment for approved application)
    string transID;
    string studentID;
    string appID;
    double amountPaid;
